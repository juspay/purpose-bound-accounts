Feature: All Transactions
  ...
  Scenario: Transactions appear after deposits
    Given a "health" account exists for holder "t1111111-1111-1111-1111-111111111111" with origin IFSC "HDFC0091111" and account number "9111100001"
    ...
    And the transactions list should contain account "t1111111"

  Scenario: Transactions include payments
    Given a "health" account exists for holder "t2222222-2222-2222-2222-222222222222" with origin IFSC "HDFC0092222" and account number "9222200001"
  ...
  Scenario: Pagination works correctly
    Given a "health" account exists for holder "t3333333-3333-3333-3333-333333333333" with origin IFSC "HDFC0093333" and account number "9333300001"
