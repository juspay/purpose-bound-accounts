...
/// Configuration for a pba_client service client.
/// 
...
impl Builder {
    ...
    /// Sets the HTTP client to use when making requests.
                            ...
                            /// # fn example() {
                            /// use std::time::Duration;
                            /// use pba_client::config::{Builder, Config};
                            /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
                            ///
                            ...
                            /// }
                            ///
                            /// let mut builder = pba_client::Config::builder();
    ...
    /// Sets the endpoint resolver to use when making requests.
                            ...
                            /// ```no_run
                            /// use pba_client::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
                            /// #[derive(Debug)]
                            ...
                            /// let config = pba_client::Config::builder().endpoint_resolver(resolver).build();
                            /// let client = pba_client::Client::from_conf(config);
                            /// ```
    ...
    /// Set the retry_config for the builder
                            ...
                            /// ```no_run
                            /// use pba_client::config::Config;
                            /// use pba_client::config::retry::RetryConfig;
                            ///
    ...
    /// Set the sleep_impl for the builder
                            ...
                            ///
                            /// ```no_run
                            /// use pba_client::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
                            ///
                            /// #[derive(Debug)]
                            ...
                            ///
                            /// ```no_run
                            /// use pba_client::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
                            ///
                            /// #[derive(Debug)]
                            /// pub struct ForeverSleep;
                            ///
    ...
    /// Set the timeout_config for the builder
                            ...
                            /// # use std::time::Duration;
                            /// use pba_client::config::Config;
                            /// use pba_client::config::timeout::TimeoutConfig;
                            ///
    ...
    /// Set the identity cache for auth.
                            ...
                            /// ```no_run
                            /// use pba_client::config::IdentityCache;
                            ///
    ...
    /// Sets the [`behavior major version`](crate::config::BehaviorVersion).
                    ...
                    /// ```no_run
                    /// use pba_client::config::BehaviorVersion;
                    ///
                    /// let config = pba_client::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone()).with_name("pba_client::config::Config").freeze(),
                                    cloneable: layer,
                ...
                pub(crate) fn new(
                    ...
                    Self {
                        config: ::aws_smithy_types::config_bag::Layer::from(layer)
                            .with_name("pba_client::config::ConfigOverrideRuntimePlugin").freeze(),
                        components,
                    }
                }
            }
...
pub(crate) fn base_client_runtime_plugins(
    ...
    if config.behavior_version.is_none() {
                    ...
                    let default_retry_partition = "purposeboundaccountservice";
                    

                    let scope = "pba_client";
