...
impl super::Client {
    ...
    ///   - [`origin_ifsc(Option<String>)`](crate::operation::get_account::GetAccountOutput::origin_ifsc): (undocumented)
    ///   - [`origin_account_number(Option<String>)`](crate::operation::get_account::GetAccountOutput::origin_account_number): (undocumented)
