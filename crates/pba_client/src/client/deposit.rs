...
impl super::Client {
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::deposit::builders::DepositFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::deposit::builders::DepositFluentBuilder::set_description):<br>required: **false**<br>Free-text narration for the deposit, stored on the transaction and returned by the transaction listings. Max 256 characters.<br>
