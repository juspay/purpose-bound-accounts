...
pub struct UpdatePbAccountStatusOutput  {
...
impl  UpdatePbAccountStatusOutput  {
    #[allow(missing_docs)] // documentation missing in model
    pub fn id(&self) -> &str {
...
impl UpdatePbAccountStatusOutput {
    /// Creates a new builder-style object to manufacture [`UpdatePbAccountStatusOutput`](crate::operation::update_pb_account_status::UpdatePbAccountStatusOutput).
    pub fn builder() -> crate::operation::update_pb_account_status::builders::UpdatePbAccountStatusOutputBuilder {
        crate::operation::update_pb_account_status::builders::UpdatePbAccountStatusOutputBuilder::default()
    }
}

/// A builder for [`UpdatePbAccountStatusOutput`](crate::operation::update_pb_account_status::UpdatePbAccountStatusOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdatePbAccountStatusOutputBuilder {
...
impl UpdatePbAccountStatusOutputBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    /// Consumes the builder and constructs a [`UpdatePbAccountStatusOutput`](crate::operation::update_pb_account_status::UpdatePbAccountStatusOutput).
    ...
    /// - [`updated_at`](crate::operation::update_pb_account_status::builders::UpdatePbAccountStatusOutputBuilder::updated_at)
    pub fn build(self) -> ::std::result::Result<crate::operation::update_pb_account_status::UpdatePbAccountStatusOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::update_pb_account_status::UpdatePbAccountStatusOutput {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building UpdatePbAccountStatusOutput")
                    )?
                ,
                holder_id: self.holder_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("holder_id", "holder_id was not specified but it is required when building UpdatePbAccountStatusOutput")
                    )?
                ,
                purpose_code: self.purpose_code
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("purpose_code", "purpose_code was not specified but it is required when building UpdatePbAccountStatusOutput")
                    )?
                ,
                ...
                kyc_tier: self.kyc_tier
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("kyc_tier", "kyc_tier was not specified but it is required when building UpdatePbAccountStatusOutput")
                    )?
                ,
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building UpdatePbAccountStatusOutput")
                    )?
                ,
                created_at: self.created_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building UpdatePbAccountStatusOutput")
                    )?
                ,
                updated_at: self.updated_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("updated_at", "updated_at was not specified but it is required when building UpdatePbAccountStatusOutput")
                    )?
                ,
            }
        )
