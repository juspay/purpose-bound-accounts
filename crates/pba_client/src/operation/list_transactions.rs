    ...
    pub(crate) async fn orchestrate(
                    ...
                    pub(crate) async fn orchestrate_with_stop_point(
                        ...
                        .instrument(::tracing::debug_span!(
                                "PurposeBoundAccountService.ListTransactions",
...
#[derive(Debug)]
    ...
    ::std::write!(output, "/accounts/{account_id}/transactions", account_id = account_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_transactions::ListTransactionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
impl ListTransactionsError {
    ...
    /// Returns `true` if the error kind is `ListTransactionsError::AccountNotFoundError`.
