...
impl GetAccountOutputBuilder {
    ...
    /// - [`id`](crate::operation::get_account::builders::GetAccountOutputBuilder::id)
    /// - [`holder_id`](crate::operation::get_account::builders::GetAccountOutputBuilder::holder_id)
    /// - [`purpose_code`](crate::operation::get_account::builders::GetAccountOutputBuilder::purpose_code)
    /// - [`origin_ifsc`](crate::operation::get_account::builders::GetAccountOutputBuilder::origin_ifsc)
    /// - [`origin_account_number`](crate::operation::get_account::builders::GetAccountOutputBuilder::origin_account_number)
    /// - [`kyc_tier`](crate::operation::get_account::builders::GetAccountOutputBuilder::kyc_tier)
    /// - [`status`](crate::operation::get_account::builders::GetAccountOutputBuilder::status)
    /// - [`created_at`](crate::operation::get_account::builders::GetAccountOutputBuilder::created_at)
    /// - [`updated_at`](crate::operation::get_account::builders::GetAccountOutputBuilder::updated_at)
    pub fn build(self) -> ::std::result::Result<crate::operation::get_account::GetAccountOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_account::GetAccountOutput {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building GetAccountOutput")
                    )?
                ,
                holder_id: self.holder_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("holder_id", "holder_id was not specified but it is required when building GetAccountOutput")
                    )?
                ,
                purpose_code: self.purpose_code
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("purpose_code", "purpose_code was not specified but it is required when building GetAccountOutput")
                    )?
                ,
                origin_ifsc: self.origin_ifsc
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("origin_ifsc", "origin_ifsc was not specified but it is required when building GetAccountOutput")
                    )?
                ,
                origin_account_number: self.origin_account_number
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("origin_account_number", "origin_account_number was not specified but it is required when building GetAccountOutput")
                    )?
                ,
                vpa: self.vpa
                ,
                ...
                kyc_tier: self.kyc_tier
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("kyc_tier", "kyc_tier was not specified but it is required when building GetAccountOutput")
                    )?
                ,
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building GetAccountOutput")
                    )?
                ,
                created_at: self.created_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building GetAccountOutput")
                    )?
                ,
                updated_at: self.updated_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("updated_at", "updated_at was not specified but it is required when building GetAccountOutput")
                    )?
                ,
            }
        )
