...
impl WithdrawOutput {
    /// Creates a new builder-style object to manufacture [`WithdrawOutput`](crate::operation::withdraw::WithdrawOutput).
    pub fn builder() -> crate::operation::withdraw::builders::WithdrawOutputBuilder {
        crate::operation::withdraw::builders::WithdrawOutputBuilder::default()
    }
}

/// A builder for [`WithdrawOutput`](crate::operation::withdraw::WithdrawOutput).
