...
impl VoidDepositOutput {
    /// Creates a new builder-style object to manufacture [`VoidDepositOutput`](crate::operation::void_deposit::VoidDepositOutput).
    pub fn builder() -> crate::operation::void_deposit::builders::VoidDepositOutputBuilder {
        crate::operation::void_deposit::builders::VoidDepositOutputBuilder::default()
    }
}

/// A builder for [`VoidDepositOutput`](crate::operation::void_deposit::VoidDepositOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct VoidDepositOutputBuilder {
...
impl VoidDepositOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`VoidDepositOutput`](crate::operation::void_deposit::VoidDepositOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`deposit_id`](crate::operation::void_deposit::builders::VoidDepositOutputBuilder::deposit_id)
    /// - [`account_id`](crate::operation::void_deposit::builders::VoidDepositOutputBuilder::account_id)
    /// - [`amount`](crate::operation::void_deposit::builders::VoidDepositOutputBuilder::amount)
    /// - [`pool`](crate::operation::void_deposit::builders::VoidDepositOutputBuilder::pool)
    /// - [`status`](crate::operation::void_deposit::builders::VoidDepositOutputBuilder::status)
    pub fn build(self) -> ::std::result::Result<crate::operation::void_deposit::VoidDepositOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::void_deposit::VoidDepositOutput {
                deposit_id: self.deposit_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("deposit_id", "deposit_id was not specified but it is required when building VoidDepositOutput")
                    )?
                ,
                account_id: self.account_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("account_id", "account_id was not specified but it is required when building VoidDepositOutput")
                    )?
                ,
                amount: self.amount
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("amount", "amount was not specified but it is required when building VoidDepositOutput")
                    )?
                ,
                pool: self.pool
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("pool", "pool was not specified but it is required when building VoidDepositOutput")
                    )?
                ,
                ...
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building VoidDepositOutput")
                    )?
                ,
