...
pub struct ListNormalAccountTransactionsInput  {
    #[allow(missing_docs)] // documentation missing in model
...
impl  ListNormalAccountTransactionsInput  {
    #[allow(missing_docs)] // documentation missing in model
...
impl ListNormalAccountTransactionsInput {
    /// Creates a new builder-style object to manufacture [`ListNormalAccountTransactionsInput`](crate::operation::list_normal_account_transactions::ListNormalAccountTransactionsInput).
    pub fn builder() -> crate::operation::list_normal_account_transactions::builders::ListNormalAccountTransactionsInputBuilder {
        crate::operation::list_normal_account_transactions::builders::ListNormalAccountTransactionsInputBuilder::default()
    }
}

/// A builder for [`ListNormalAccountTransactionsInput`](crate::operation::list_normal_account_transactions::ListNormalAccountTransactionsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListNormalAccountTransactionsInputBuilder {
...
impl ListNormalAccountTransactionsInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    /// Consumes the builder and constructs a [`ListNormalAccountTransactionsInput`](crate::operation::list_normal_account_transactions::ListNormalAccountTransactionsInput).
    pub fn build(self) -> ::std::result::Result<crate::operation::list_normal_account_transactions::ListNormalAccountTransactionsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_normal_account_transactions::ListNormalAccountTransactionsInput {
