...
/// Orchestration and serialization glue logic for `CreateAccount`.
...
impl CreateAccount {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_account::CreateAccountOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_account::CreateAccountError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_account::CreateAccountError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_account::CreateAccountOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) async fn orchestrate_with_stop_point(
                        ...
                        .instrument(::tracing::debug_span!(
                                "PurposeBoundAccountService.CreateAccount",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateAccount {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateAccount");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateAccountRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateAccountResponseDeserializer));
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateAccount")
                            .with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(CreateAccountEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_account::CreateAccountError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_account::CreateAccountError>::new());
...
#[derive(Debug)]
            struct CreateAccountResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateAccountResponseDeserializer {
            ...
            let parse_result = if !success && status != 201 || force_error {
                crate::protocol_serde::shape_create_account::de_create_account_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_account::de_create_account_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateAccountRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateAccountRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_account::CreateAccountInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_account::CreateAccountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_account::ser_create_account_input(&input)?);
...
#[derive(Debug)]
            struct CreateAccountEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateAccountEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateAccountEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateAccountInput>()
                        .ok_or("failed to downcast to CreateAccountInput")?;
...
pub enum CreateAccountError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateAccountError) for what information is available for the error.")]
...
impl CreateAccountError {
    /// Creates the `CreateAccountError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateAccountError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateAccountError::PurposeTypeNotFoundError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateAccountError {
