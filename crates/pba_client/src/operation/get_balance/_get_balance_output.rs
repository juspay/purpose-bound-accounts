...
impl GetBalanceOutput {
    /// Creates a new builder-style object to manufacture [`GetBalanceOutput`](crate::operation::get_balance::GetBalanceOutput).
    pub fn builder() -> crate::operation::get_balance::builders::GetBalanceOutputBuilder {
        crate::operation::get_balance::builders::GetBalanceOutputBuilder::default()
    }
}

/// A builder for [`GetBalanceOutput`](crate::operation::get_balance::GetBalanceOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetBalanceOutputBuilder {
...
impl GetBalanceOutputBuilder {
    ...
    /// - [`account_id`](crate::operation::get_balance::builders::GetBalanceOutputBuilder::account_id)
