...
pub use crate::operation::make_payment::_make_payment_output::MakePaymentOutputBuilder;

pub use crate::operation::make_payment::_make_payment_input::MakePaymentInputBuilder;

impl crate::operation::make_payment::builders::MakePaymentInputBuilder {
                    ...
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.make_payment();
...
pub struct MakePaymentFluentBuilder {
                ...
                inner: crate::operation::make_payment::builders::MakePaymentInputBuilder,
...
impl MakePaymentFluentBuilder {
    /// Creates a new `MakePaymentFluentBuilder`.
    ...
    /// Access the MakePayment as a reference.
                    pub fn as_input(&self) -> &crate::operation::make_payment::builders::MakePaymentInputBuilder {
                        &self.inner
                    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::make_payment::MakePaymentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::make_payment::MakePaymentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::make_payment::MakePayment::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::make_payment::MakePayment::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::make_payment::MakePaymentOutput, crate::operation::make_payment::MakePaymentError, Self> {
