...
/// Orchestration and serialization glue logic for `GetPurposeType`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetPurposeType;
impl GetPurposeType {
    /// Creates a new `GetPurposeType`
    pub fn new() -> Self {
        Self
    }
...
impl GetPurposeTypeError {
    ...
    /// Returns `true` if the error kind is `GetPurposeTypeError::PurposeTypeNotFoundError`.
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetPurposeTypeError {
