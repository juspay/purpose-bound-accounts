...
pub use crate::operation::deposit_to_pb_account::_deposit_to_pb_account_input::DepositToPbAccountInputBuilder;

pub use crate::operation::deposit_to_pb_account::_deposit_to_pb_account_output::DepositToPbAccountOutputBuilder;

impl crate::operation::deposit_to_pb_account::builders::DepositToPbAccountInputBuilder {
                    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        crate::operation::deposit_to_pb_account::DepositToPbAccountOutput,
                        ::aws_smithy_runtime_api::client::result::SdkError<
                            crate::operation::deposit_to_pb_account::DepositToPBAccountError,
                            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse
                        >
                    > {
                        let mut fluent_builder = client.deposit_to_pb_account();
                        fluent_builder.inner = self;
                        fluent_builder.send().await
                    }
                }
/// Fluent builder constructing a request to `DepositToPBAccount`.
/// 
...
pub struct DepositToPBAccountFluentBuilder {
                handle: ::std::sync::Arc<crate::client::Handle>,
                inner: crate::operation::deposit_to_pb_account::builders::DepositToPbAccountInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::deposit_to_pb_account::DepositToPbAccountOutput,
                    crate::operation::deposit_to_pb_account::DepositToPBAccountError,
                > for DepositToPBAccountFluentBuilder
            {
                fn send(
                    self,
...
impl DepositToPBAccountFluentBuilder {
    /// Creates a new `DepositToPBAccountFluentBuilder`.
    ...
    /// Access the DepositToPBAccount as a reference.
                    pub fn as_input(&self) -> &crate::operation::deposit_to_pb_account::builders::DepositToPbAccountInputBuilder {
                        &self.inner
                    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::deposit_to_pb_account::DepositToPbAccountOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deposit_to_pb_account::DepositToPBAccountError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::deposit_to_pb_account::DepositToPBAccount::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::deposit_to_pb_account::DepositToPBAccount::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::deposit_to_pb_account::DepositToPbAccountOutput, crate::operation::deposit_to_pb_account::DepositToPBAccountError, Self> {
