...
impl PurposeTypeSummary {
    /// Creates a new builder-style object to manufacture [`PurposeTypeSummary`](crate::types::PurposeTypeSummary).
    pub fn builder() -> crate::types::builders::PurposeTypeSummaryBuilder {
        crate::types::builders::PurposeTypeSummaryBuilder::default()
    }
}

/// A builder for [`PurposeTypeSummary`](crate::types::PurposeTypeSummary).
