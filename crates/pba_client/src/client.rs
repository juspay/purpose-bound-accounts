...
/// For example, the [`CreateAccount`](crate::operation::create_account) operation has
/// a [`Client::create_account`], function which returns a builder for that operation.
...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), pba_client::Error> {
/// # let client: pba_client::Client = unimplemented!();
